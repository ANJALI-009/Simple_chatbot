...
client = Groq(
 api_key=("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"),
)
...
st.markdown(
    ...
    <style>
        .stApp {
            ...
            left: -20%;
            top: -10%;
            background-image:url("https://images.playground.com/1faea2b91ca0440c9c8e566ee50ef82a.jpeg");
